  ...
  return (
    <div className="bg-rewayLighterGray py-6 flex justify-between px-14 items-center mb-8 max-md:py-2 max-md:px-8 max-lg:px-8">
      ...
      <div className="flex gap-6 items-center max-md:flex-col">
        ...
        <button className="font-suez border-[3px] px-3 py-1 rounded-[4px] border-rewayBlue uppercase font-semibold text-rewayBlue max-md:text-sm">
          Find a store
        </button>
        <Link
          href="#"
          className="font-suez text-rewayGrey font-semibold uppercase text-[17px] max-md:hidden hover:text-rewayBlue transition-all duration-500"
        >
          Not in South Africa?
        </Link>
      </div>
